...
class FSBDWheelList
{
    public List<FSBDWheelClass> wheels;
    ...
    {
        wheels = new List<FSBDWheelClass>();
        for (int i = 0; i < colliders.Count; i++)
        {
            wheels.Add(new FSBDWheelClass(colliders[i]));
    ...
    {
        wheels = new List<FSBDWheelClass>();
        wheels.Add(new FSBDWheelClass(collider, wheelMesh, suspensionParent));
    }
